...
extern "C" void * createRTXIPlugin(void) {
	return new Neuron();
}
...
/*static DefaultGUIModel::variable_t vars[] =
	...
	{ "Iapp_offset", "uA/cm^2 - Current added to the input.", DefaultGUIModel::PARAMETER | DefaultGUIModel::DOUBLE, },
	{ "rate", "Hz - The rate of integration.", DefaultGUIModel::PARAMETER | DefaultGUIModel::UINTEGER, },
