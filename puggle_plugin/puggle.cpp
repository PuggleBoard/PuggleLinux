...
Puggle::Puggle(void) :
  DefaultGUIModel("Puggle with Custom GUI", ::vars, ::num_vars)
{

  QWhatsThis::add(this, "<p><b>Puggle:</b><br>QWhatsThis description.</p>");
...
void
Puggle::update(DefaultGUIModel::update_flags_t flag)
{
  switch (flag)
    {
  case INIT:
...
void
Puggle::createGUI(DefaultGUIModel::variable_t *var, int size)
{
